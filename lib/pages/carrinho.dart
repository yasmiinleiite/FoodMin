...
import 'package:flutter/material.dart';
import 'package:flutter_application_1/services/api_carrinho.dart';
import 'package:flutter_application_1/services/api_historico.dart'; // ✅ adicionado
import 'package:flutter_application_1/pages/historico.dart';         // ✅ adicionado
import 'package:flutter_application_1/icons/lixeira.dart'; 
import 'package:flutter_application_1/icons/editar.dart';
                      ...
                      return Container(
                        ...
                        child: Column(                          // ✅ era Row
                          children: [
                            ...
                            const SizedBox(height: 12),          // ✅ adicionado
                            SizedBox(                            // ✅ adicionado
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () async {
                                  final itens = await CarrinhoService.buscarItens();
                                  if (itens.isEmpty) return;

                                  await HistoricoService.salvarCompra(
                                    total: total,
                                    itens: itens.map((i) => {
                                      'titulo': i.titulo,
